...
parser.add_argument('--username', type=str, default='admin', help='NSO username')
parser.add_argument('--password', type=str, default='admin', help='NSO password')
...
class DeleteService(aetest.Testcase):
    ...
    def delete_service(self, steps):
        ...
        with steps.start('Deleting service from device') as step:
            ...
            if response.status_code in [200, 201, 204]:
                step.passed('Successfully deleted service from device')
            else:
